...
#define CMD_MAX                        100.0F                    /* �O�i/���񖽗ߐ��΍ő��l */
#define DEG2RAD                        0.01745329238F            /* �p�x�P�ʕϊ��W��(=pi/180) */
//#define EXEC_PERIOD                    0.00400000019F            /* �o�����X�������s����(�b) */
#define EXEC_PERIOD                    0.00500000000F            /* �o�����X�������s����(�b) *//* forEV3 20141102koji */
