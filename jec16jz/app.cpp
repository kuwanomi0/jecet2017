...
#define TAIL_ANGLE_ROKET      99 /* 完全停止時の角度[度] */
#define TAIL_ANGLE_DRIVE       3 /* バランス走行時の角度[度] */
#define TAIL_ANGLE_STOP       80 /* バランス走行時の角度[度] */
...
static Course gCourse[]  {
    { 0,     0,100, 0.0000F, 0.0000F, 0.0000F },  // 左旋回1.25秒
    { 0,    10, 85, 0.0600F, 0.0000F, 0.0000F },  // 左旋回1.25秒
    { 1,  2221,100, 0.1000F, 0.0000F, 0.0010F },  // 直進5秒
    { 2,  3641, 85, 0.1000F, 0.0000F, 0.1000F },  // 直進5秒
    { 3,  5197, 85, 0.1200F, 0.0000F, 0.1000F },  // 左旋回1.25秒
    { 4,  6786, 85, 0.1200F, 0.0000F, 0.1000F },   // 直進2.5秒
    { 5,  8400, 85, 0.0600F, 0.0000F, 0.0000F },   // 直進2.5秒
    { 6, 10031,100, 0.1200F, 0.0000F, 0.1000F },   // 直進2.5秒
    { 7, 99999,  1, 0.1200F, 0.0000F, 0.1000F },   // 直進2.5秒

    { 0,     0,100, 0.0000F, 0.0000F, 0.0000F },  // 左旋回1.25秒
    { 0,    10, 85, 0.0600F, 0.0000F, 0.0000F },  // 左旋回1.25秒
    { 1,  2251,100, 0.1000F, 0.0000F, 0.0010F },  // 直進5秒
    { 2,  5383, 85, 0.1000F, 0.0000F, 0.1000F },  // 直進5秒
    { 3,  6298, 85, 0.1200F, 0.0000F, 0.1000F },  // 左旋回1.25秒
    { 5,  8600, 85, 0.1200F, 0.0000F, 0.1000F },   // 直進2.5秒
    { 4,  7228, 85, 0.0600F, 0.0000F, 0.0000F },   // 直進2.5秒
    { 6, 10298,100, 0.1200F, 0.0000F, 0.1000F },   // 直進2.5秒
    { 7, 99999,  1, 0.1200F, 0.0000F, 0.1000F },   // 直進2.5秒
};
    ...
    */
    while(1)
    {
        ...
        if (bt_cmd == 6) {
            ...
            tail_control(TAIL_ANGLE_ROKET); /* バランス走行用角度に制御 */
        else {
    ...
    if (distance_now >= gCourse[count].getDis()) {
        course_number = gCourse[count].getCourse_num();
        forward = gCourse[count].getForward();
        pid_walk.setPID(gCourse[count].getP(), gCourse[count].getI(), gCourse[count].getD());
        count++;
    }
