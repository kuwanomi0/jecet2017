...
#define RGB_TARGET          /*185  85*/ 115 /*中央の境界線のRGBセンサ合計値 */
...
static Course gCourse[]  {   //TODO :2 非常にひどい書き方だと思います。見直しが必要
    /* Lコース用配列  コマンド1 */
    /*区間、距離、フォワード、PID*/
    { 0,     0, 30, 0.0700F, 0.0000F, 0.0000F },   //TODO :2 順序番号、距離、フォワード、P、I、D
    ...
    /* Rコース用配列 コマンド ２*/
    { 0,     0, 60, 0.0700F, 0.0000F, 0.0100F },   //TODO :2 非常にひどい書き方だと思います。見直しが必要
    { 1,  2251, 60, 0.0800F, 0.0000F, 0.1000F },   //TODO :2 非常にひどい書き方だと思います。見直しが必要
    { 2,  5383, 60, 0.1000F, 0.0000F, 0.1000F },   //TODO :2 非常にひどい書き方だと思います。見直しが必要
    { 3,  6298, 55, 0.1200F, 0.0000F, 0.1000F },   //TODO :2 非常にひどい書き方だと思います。見直しが必要
    { 4,  7348, 50, 0.1500F, 0.0000F, 0.1000F },   //TODO :2 非常にひどい書き方だと思います。見直しが必要
    { 5,  8900, 60, 0.1100F, 0.0000F, 0.0300F },   //TODO :2 非常にひどい書き方だと思います。見直しが必要
...
void main_task(intptr_t unused)
{
    ...
    while(1)
    {
        ...
        // スタート前の尻尾調整
        if (ev3_button_is_pressed(DOWN_BUTTON) || bt_cmd == 'f') {
            angle -= 0.1;
            bt_cmd = 0; // コマンドリセット
        }
...
void bt_task(intptr_t unused)
{
    while(1)
    {
        ...
        if (!(bt_cmd == 'u' || bt_cmd == 'c')) {    // TODO uとdのときはエコーバックしないようにしたい。未完成
            fputc(c, bt); /* エコーバック */
        }
    }
}
